...
3. While 登録済みの植物に画像 URL がある, the Green Mate shall その画像を一覧上で植物を識別する補助情報として表示する
4. While 登録済みの植物に画像 URL がない, the Green Mate shall 画像がない状態でも植物名で植物を識別できる一覧表示を維持する
5. When ユーザーが一覧内の植物を選択する, the Green Mate shall 選択された植物の詳細を表示する
