...
async function verifyGalleryDeleteFlow() {
  ...
  assert.match(source, /class="grid gap-3 rounded-md bg-stone-50 p-3"/)
  assert.match(source, /class="grid gap-3 rounded-md border border-leaf-200 bg-leaf-50\/60 p-4"/)
